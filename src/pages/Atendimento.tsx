...
import { HeartHandshake, CalendarDays, Settings2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Sessões coletivas, solicitações individuais e tipos de atendimento</p>
      </div>
